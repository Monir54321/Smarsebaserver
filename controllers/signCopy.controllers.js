const { createNewSignCopyService, getAllSignCopyService, getASignCopyService, getASignCopyDataByEmailService, updateASignCopyService, deleteASignCopyService } = require("../services/signCopy.services");
...
exports.updateASignCopyControllers = async(req, res) => {
    try {
        const _id = req.params._id;
        const data = req.body;
        const result = await updateASignCopyService({_id, data});
